...
import hr.fer.zemris.apr.hw04.ea.fitness.F1;
...
public class Demo {
    ...
    public static void main(String[] args) {
        ...
        Mutation<Solution<Boolean>> mutation = new SimpleBinaryMutation(RANDOM);
        Decoder<Solution<Boolean>> decoder = new NaturalBinaryDecoder(lbs, ubs, bitsPerVariable);
