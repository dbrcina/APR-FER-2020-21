...
public class Matrix extends AbstractMatrix {
    ...
    @Override
    public double[] columnData(int column) {
        testOutOfBounds(0, column, "columnData(int)");
        return Arrays.stream(data).mapToDouble(row -> row[column]).toArray();
    }
