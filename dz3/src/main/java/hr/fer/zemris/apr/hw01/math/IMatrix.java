...
public interface IMatrix {
    ...
    /**
     * Multiplies each element of <b>this</b> IMatrix object by provided <code>other</code> matrix.
     *
     * @param other scalar matrix.
     *
     * @return <b>this</b> IMatrix object.
     *
     * @throws IllegalArgumentException if dimensions of both IMatrix objects are not equal.
     */
    IMatrix scalarElementWise(IMatrix other);

    /**
     * Creates a new IMatrix object and then applies {@link #scalarElementWise(IMatrix)} method.
     *
     * @param other scalar matrix.
     *
     * @return new instance of IMatrix as a result.
     */
    default IMatrix nScalarElementWise(IMatrix other) {
        return copy().scalarElementWise(other);
    }
     ...
     * @param column column index.
     *
     * @return column data at <code>column</code> index.
     *
     * @throws IndexOutOfBoundsException if <code>column</code> index is invalid.
     */
    double[] columnData(int column);
